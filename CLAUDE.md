...
| נוסחאות הספר (דיאלוג הבחירה, פתיחה בחלונית לצד) | `test/library/view/book_versions_dialog_test.dart`, `test/text_book/view/text_book_screen_actions_test.dart`, `test/tabs/bloc/pane_events_test.dart` |
