...
class PatchDownloader {
  ...
  /// פונקציית חילוץ ניתנת להזרקה (לבדיקות, ללא platform channel).
  ...
  PatchDownloader({
    ...
    Zstandard? zstandard,
    Future<Uint8List?> Function(Uint8List compressed)? decompress,
  ...
  Future<String> downloadAndExtract({
    ...
    try {
      ...
      final extracted = await (_decompress != null
          ? _decompress(compressed)
          : _zstandard.decompress(compressed));
