...
const Map<String, PluginPermissionInfo> _permissionLabels = {
  ...
  'app.run_on_startup': PluginPermissionInfo(
    label: 'ריצה ברקע ללא פתיחת התוסף',
    description:
        'התוסף יוכל לפעול ברקע בלי שתפתחו אותו: טעינה עם עליית אוצריא, או הפעלה שקטה בעקבות לחיצה על פקד שלו או אירוע שהוא ביקש לעקוב אחריו. מומלץ רק לתוספים שצריכים לעקוב אחרי אירועים או לתזמן פעולות.',
  ),
