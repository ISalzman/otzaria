    ...
    final steps = <TourStep>[
      if (isRestart)
        TourStep(
          ...
          title: 'הסיור המודרך',
          body: libraryLoaded
              ? 'הסיור יעבור על כל הפיצ׳רים המרכזיים של אוצריה.\nלחץ "אני מוכן" כשתהיה מוכן להתחיל.'
    ...
    if (!libraryLoaded) {
      return [
        ...
        const TourStep(
          ...
          body:
              'כדי להשתמש באוצריה, צריך ספרייה של ספרים. אפשר להוריד את הספרייה, לבחור תיקייה קיימת או לחלץ מקובץ ZIP.',
