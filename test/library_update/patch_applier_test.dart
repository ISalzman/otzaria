...
import 'package:otzaria/library_update/models/delta_manifest.dart';
import 'package:otzaria/library_update/services/logical_content_hasher.dart';
import 'package:otzaria/library_update/services/patch_applier.dart';
...
void main() {
  ...
  group('PatchApplier against real DBs', () {
    const dir = '/Users/david/Downloads/releases';
    ...
    test('apply v1→v2 מצליח ומגיע ל-db_version=2 ול-toContentHash', () {
      ...
      const patchPath = '$dir/v2/patch-v1-v2.db';
    ...
    test('apply v2→v3 מצליח ומגיע ל-toContentHash', () {
      ...
      const patchPath = '$dir/v3/patch-v2-v3.db';
      if (dbPath == null || !File(patchPath).existsSync()) {
